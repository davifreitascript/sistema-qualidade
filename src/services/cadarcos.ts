...
function converterTesteDoBanco(teste: TesteBanco): TesteCadarcos {
    return {
        uuid: teste.uuid,
        id: teste.id,
        data: teste.data,
...
export async function criarTeste(teste: TesteCadarcos): Promise<TesteCadarcos> {
