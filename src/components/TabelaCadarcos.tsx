...
type Props = {
  testes: TesteCadarcos[];
  testesFiltrados: TesteCadarcos[];
  filtroLote: string;
  ...
  editarTeste: (teste: TesteCadarcos) => void;
  solicitarExclusao: (teste: TesteCadarcos, numero: number) => void;
  sincronizarBanco: () => Promise<void>;
  statusSync: "idle" | "loading" | "success";
};

export function TabelaCadarcos({
  testes,
  testesFiltrados,
  filtroLote,
  ordemAdicao,
